...
public class VehicleRepositoryTest {
	...
	public void testAddVehicleWithSucces(){
		...
		int nrOfVehicles2 = vehicleRepository.getNumberOfVehicles();
		assertEquals(noOfVehicles + 1, nrOfVehicles2);
	...
	public void testAddVehiclesWhenInvalidConditions(){
        ...
        assertEquals(noOfVehicles, vehicleRepository.getNumberOfVehicles());
	}
