...
public class MainView implements IObserver {
    ...
    public void initializeValues() {
        ...
        for(int i = 0; i< currentConfig.size(); i++){
            values[i/5][i%5]= currentConfig.get(i);
            System.out.println(values[i/5][i%5]+" ");
            if(i==5){
                System.out.println("\n");
            }
        }
    ...
    public void finishGame(int tries) {
        ...
        Game game=new Game(player,points,(int)timeToFinish,config.getConfiguration(),proposedMoves);
        game.setId(0);
