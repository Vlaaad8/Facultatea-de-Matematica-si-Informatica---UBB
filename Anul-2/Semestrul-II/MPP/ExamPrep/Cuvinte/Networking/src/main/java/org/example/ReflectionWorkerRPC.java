...
public class ReflectionWorkerRPC implements Runnable, IObserver {
    ...
    private Response handleRequest(Request request) {
        ...
        try {
            ...
            System.out.println("Trying to find method: " + handlerName);
            ...
            System.err.println("No such method: " + handlerName);
            e.printStackTrace();
        } catch (InvocationTargetException e) {
            System.err.println("Exception inside method: " + handlerName);
            e.getCause().printStackTrace();  // ← foarte important
        } catch (IllegalAccessException e) {
            System.err.println("Illegal access to method: " + handlerName);
            e.printStackTrace();
        }
