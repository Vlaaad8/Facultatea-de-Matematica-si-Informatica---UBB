...
1. 🗄️ **Baze de Date (BD)**
2. 🚀 **Metode Avansate de Programare (MAP)**
3. 🔗 **Programare Logică și Funcțională (PLF)**
4. 🖥️ **Rețele de Calculatoare**
5. 📉 **Probabilități și Statistică**

### 🟨 Anul 2 - Semestrul II

1. 🤖 **Inteligență Artificială (AI)**
2. 🛠️ **Ingineria Sistemelor Software (ISS)**
3. 🔧 **Medii de Proiectare și Programare (MPP)**
4. 🗃️ **Sisteme de Gestiune a Bazelor de Date (SGBD)**
5. 🌐 **Programare Web**
